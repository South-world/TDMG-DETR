...
from engine.backbone.dualhgnetv2 import HG_Stage,GateBlock
...
from engine.extre_module.custom_nn.neck.MFF import FocusFeature, ADown, MGDF
from engine.extre_module.custom_nn.transformer.TDMSA import TDMSA

from engine.extre_module.custom_nn.transformer.MSCF import MSCF
...
def parse_module(d, i, f, m, args, ch, nc=None, eval_spatial_size=None):
    ...
    if m in { HG_Stage, GateBlock,}:
        ...
        c2 = ch[f]
        args = [c2, *args]
    elif m in { ADown, Conv}: # Conv
        c1, c2 = ch[f], args[0]
        args = [c1, c2, *args[1:]]
    elif m in {C3_Block, C2f_Block, C3k2_Block, MetaFormer_Block, MetaFormer_Mona, MetaFormer_SEFN, MetaFormer_Mona_SEFN}: # Block
        c1, c2 = ch[f], args[0]
